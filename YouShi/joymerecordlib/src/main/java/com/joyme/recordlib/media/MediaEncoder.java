...
//		android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
        ...
        while (isRunning) {
            ...
            if (localRequestStop) {
                Log.d(TAG,"drain1111111111111111111");
                drain();

                // request stop recording
                signalEndOfInputStream();
                 // process output data again for EOS signale
                Log.d(TAG,"drain22222222222222222");
                drain();
            ...
            if (localRequestDrain) {
                Log.d(TAG,"drain333333333333333333");
                drain();
            } else {
                synchronized (mSync) {
                    try {
        ...
        synchronized (mSync) {
            //    Log.d("==========","stop mSync "+getClass().getName());
            mRequestStop = true;
            mIsCapturing = false;
        }
    }
...
//        Log.d("==============","signalEndOfInputStream");
//        // signalEndOfInputStream is only avairable for video encoding with surface
//        // and equivalent sending a empty buffer with BUFFER_FLAG_END_OF_STREAM flag.
//        if (this instanceof MediaScreenEncoder){
//            mMediaCodec.signalEndOfInputStream();	// API >= 18
//            Log.d("===========", "MediaScreenEncoder end  ");
//        }else {
//            encode(null, 0, getPTSUs());
//            Log.d("===========", "AudioRecord end  ");
//        }
//
//        mIsEOS = true;
//
